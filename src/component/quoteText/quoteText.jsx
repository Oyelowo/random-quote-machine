...
const quoteText = (props) => {
    return (
        <div id="text" className={styles.quoteText} style={{background: 'white', opacity: '0.9'}}>
            ...
            <Button id="new-quote" style={{color: props.textColor, border: `1px solid ${props.textColor}`}} onClick={props.newQuoteBtn}>NEW QUOTE</Button>
